          ...
          <div class="login-form">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
              <el-form-item prop="account">
                <el-input :placeholder="$t('login.userplaceholder')" v-model="ruleForm.account"></el-input>
              </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        account: storage.get('loginUser'),
        password: ''
      },
      rules: {
        account: [{ validator: validfn, trigger: 'blur', required: true }],
    ...
    async handleLogin() {
      this.loading = true
       try {
            ...
            this.remember
              ? storage.set('loginUser', account)
              : storage.remove('loginUser', account)
